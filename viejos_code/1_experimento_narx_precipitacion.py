...
# Definiendo funcion de prediccion
...
if __name__ == "__main__":
    ...
    experimento = f'experiments/narx/precipitacion/narx_prec_{id_point}_{len(n_neurons)}_{activation[0]}_{prediction_order}_{auto_order}_{exog_order}_{exog_delay}'
