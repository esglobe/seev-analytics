...
def anomalia_periodo(year = 2020):
    ...
    anomalias = [
            [0,1946,1950,1916,1945],#1916,1945
            [1,1951,1955,1921,1950],#1921,1950
            [2,1956,1960,1926,1955],#1926,1955
            [3,1961,1965,1931,1960],#1931,1960
            [4,1966,1970,1936,1965],#1936,1965--
            [5,1971,1975,1941,1970],#1941,1970
            [6,1976,1980,1946,1975],#1946,1975
            [7,1981,1985,1951,1980],#1951,1980
            [8,1986,1990,1956,1985],#1956,1985
            [9,1991,1995,1961,1990],#1961,1990
            [10,1996,2000,1966,1995],#1966,1995
            [11,2001,2005,1971,2000],#1971,2000
            [12,2006,2010,1976,2005],#1976,2005
            [13,2011,2015,1981,2010],#1981,2010
            [14,2016,2020,1986,2015],#1986,2015
            [15,2021,2025,1991,2020],#1991,2020
            ]
    ...
    value = list(filter(
                        ...
                        anomalias
                        # [
                        # [1,1951,1955,1936,1965],#1921,1950
                        # [2,1956,1960,1941,1970],#1926,1955
                        # [3,1961,1965,1946,1975],#1931,1960
                        # [4,1966,1970,1951,1980],#1936,1965--
                        # [5,1971,1975,1956,1985],#1941,1970
                        # [6,1976,1980,1961,1990],#1946,1975
                        # [7,1981,1985,1966,1995],#1951,1980
                        # [8,1986,1990,1971,2000],#1956,1985
                        # [9,1991,1995,1976,2005],#1961,1990
                        # [10,1996,2000,1981,2010],#1966,1995
                        # [11,2001,2005,1986,2015],#1971,2000
                        # [12,2006,2010,1991,2020],#1976,2005
                        # [13,2011,2015,1996,2025],#1981,2010
                        # [14,2016,2020,2001,2030],#1986,2015
                        # [15,2021,2025,2006,2035],#1991,2020
...
def periodo_anomalias_climaticas(data_pandas):
    ...
    pd_periodo_anomalias = pd.DataFrame(anomalias,
                                    #     [
